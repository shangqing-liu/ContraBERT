...
from clonemodel import CloneModel
...
def test(args, model, tokenizer):
    ...
    answers = extract_answers(args.test_data_file)
    with open(os.path.join(args.output_dir, "answers.jsonl"), 'w') as f:
        for line in answers:
            f.write(json.dumps(line) + '\n')
    answers = read_answers(os.path.join(args.output_dir, "answers.jsonl"))
    predictions = read_predictions(os.path.join(args.output_dir, "predictions.jsonl"))
